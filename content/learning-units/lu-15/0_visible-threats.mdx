...
Toward the end of the 20th century, two key technologies – GPS and satellite communication uplinks – rendered military drones much more capable as they now could be piloted with precision from a great distance. The well-known MQ-1 Predator, for instance, was already used for reconnaissance in the Balkan wars of the 1990s.
...
Following this video, the learning unit will give you an overview over the proliferation of drones and also showcase some examples for systems with specific autonomous functions. After that, we will take a look into the immediate future and explore the development of fully autonomous military robots, or what is currently discussed under the label “lethal autonomous weapon systems”.
